...
// Placeholder policy (must stay fixed until hardware modules are wired):
// - battery: ADC/BMS 연동 전까지 placeholder(-1.0)
// - speed: 엔코더/주행 계산 로직 연동 전까지 placeholder(-1.0)
// - x, y: localization 연동 전까지 placeholder(-1.0)
// - heading: IMU yaw 연동 전까지 placeholder(-1.0)
