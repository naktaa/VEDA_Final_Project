#include <iostream>
  ...
  {
      // Prefer front(28) first, then top(30), then side/back faces.
      switch (id) {
          case 28: return 0;
          case 30: return 1;
          case 27: return 2;
  ...
  {
      // Convert per-face marker yaw to forward(28) reference yaw.
      constexpr double PI = 3.14159265358979323846;
      switch (id) {
          case 28: return 0.0;       // front
          case 30: return 0.0;       // top (assumed aligned with front)
          case 27: return -PI * 0.5; // right -> front
          case 29: return PI * 0.5;  // left -> front
          case 26: return PI;        // back -> front
          default: return 0.0;
      }
  }
  ...
  int main(int argc, char** argv)
  {
      ...
      const std::string homographyYaml = (argc > 5)
          ? argv[5]
          : "/home/pi/final_veda_test/map/H_img2world.yaml";
